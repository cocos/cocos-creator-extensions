...
export const DefaultConfig: FloatWindowConfig = {
    key: 'preview',
    tab: {
        name: 'i18n:creator-graph.preview.menu_name',
        show: true,
        height: 80,
    },
    base: {
        title: 'i18n:creator-graph.preview.title',
        width: '223px',
        height: '228px',
        minWidth: '223px',
        minHeight: '228px',
...
export const component = defineComponent({
    ...
    template: commonTemplate({
        css: 'preview',
        header: `
<ui-label class="title-label" value="i18n:creator-graph.preview.title"></ui-label>
<ui-icon class="close" transparent
  tooltip="i18n:creator-graph.preview.close.tooltip"
...
></ui-icon>
        ...
        section: `
            ...
            <div class="primitive-group">
                <ui-label slot="label" value="i18n:creator-graph.preview.mesh"></ui-label>
