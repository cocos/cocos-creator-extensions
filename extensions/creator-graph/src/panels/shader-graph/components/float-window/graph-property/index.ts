...
export const DefaultConfig: FloatWindowConfig = {
    key: 'graph-property',
    tab: {
        name: 'i18n:creator-graph.graph_property.menu_name',
        show: true,
        height: 80,
    },
    base: {
        title: 'i18n:creator-graph.graph_property.title',
        width: '300px',
        height: '240px',
        minWidth: '300px',
        minHeight: '240px',
...
<div class="property-title">
    <ui-label class="name" 
        value="i18n:creator-graph.graph_property.add">
    </ui-label>
    <ui-icon class="add"  
        value="add-more"
        @click.stop="onPopupMenu()"
        tooltip="i18n:creator-graph.graph_property.add">
    </ui-icon>
</div>
    ...
    >
        ...
        <div class="delete">
            <ui-icon class="icon" v-if="property.showDelete"
                :tooltip="'i18n:creator-graph.graph_property.delete'"
                value="close" 
