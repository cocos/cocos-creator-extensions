...
export function getBaseMenuItem(event: BlockMouseEvent | GraphMouseEvent | LineMouseEvent, popupCreateMenu: () => void): Editor.Menu.ContextMenuItem[] {
    ...
    return [
        {
            label: Editor.I18n.t('creator-graph.right_menu.create_node'),
            enabled: !uuid,
            visible: !isLine,
            accelerator: 'Space',
            click: () => {
        ...
        { type: 'separator' },
        {
            label: Editor.I18n.t('creator-graph.right_menu.paste'),
        ...
        {
            label: Editor.I18n.t('creator-graph.right_menu.delete'),
            accelerator: 'Delete',
            enabled: uuid !== '',
            click: () => {
        ...
        {
            label: Editor.I18n.t('creator-graph.right_menu.copy'),
        ...
        {
            label: Editor.I18n.t('creator-graph.right_menu.duplicate'),
        ...
        { type: 'separator' },
        {
            label: Editor.I18n.t('creator-graph.right_menu.zoom_to_fit'),
            enabled: uuid === '',
            visible: !isLine,
            click: () => {
        ...
        {
            label: Editor.I18n.t('creator-graph.right_menu.reset'),
            enabled: uuid === '',
            visible: !isLine,
            click: () => {
